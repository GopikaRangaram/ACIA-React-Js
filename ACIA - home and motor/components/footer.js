...
<Col style={{paddingTop:"115px"}}>
       ...
       <Row className="description">ACIA is a complete insurance product solution that is pre packaged</Row>
...
<Col lg={2}>
      ...
      <Row xs={1} md={1} lg={2}>
       <Col className="p-0"><Image className="facebook" src={require('../images/Group 216.png').default} /></Col>
       <Col className="p-0"><Image className="linkedIn" src={require('../images/Group 215.png').default} /></Col>
      </Row>

      <Row xs={1} md={1} lg={2}  className='pt-3'>
        <Col className="p-0"><Image className="twitter" src={require('../images/Group 217.png').default} /></Col>
        <Col className="p-0"><Image className="youTube" src={require('../images/Group 218.png').default} /></Col>
      </Row>
